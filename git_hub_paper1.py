def Find_SA_for_Genome(L=100,l=100,G_file='COMPLETE_GENOME_E coli K12 MG1655 Mutated FASTA 1.4 MB.fasta'):    
...
#Output:   suffix:Suffix Array
    ...
    x=x="SA_"+G_file+"_DevTo"+str(L)+"_Overlap"+str(l)+".txt"
...
if __name__ == "__main__":
    print("1_ find SA")
    G_file='COMPLETE_GENOME_E coli K12 MG1655 Mutated FASTA 1.4 MB.fasta'    
    Find_SA_for_Genome(G_file=G_file)
